...
*   1 June, 2015
*   Func: Standard Error Definition of System for Semptian Ltd
*   Personal.Q
*/

#ifndef __CPSS_GENERIC_ERRNO_BASE_H__
#define __CPSS_GENERIC_ERRNO_BASE_H__
...
extern const char * rt_errno2string(rt_errno err);
